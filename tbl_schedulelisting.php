...
?>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="card-body">
        ...
        $query = "Select a.id,a.match_no,b.title as series_title,c.title as season_title,d.title as team_1,e.title as team_2 FROM tbl_schedule a 
 ...
 <td>
          <a href='update6.php?id=<?php echo $row['id']; ?>'>Update</a>
           <a href='delete6.php?id=<?php echo $row['id']; ?>'>Delete</a>
           </td>
              </tr>
              <?php
            }
