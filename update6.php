...
{
if(count($_POST)>0) {
    $sql = "UPDATE tbl_schedule SET series_id='" . $_POST['series_id'] . "',season_id='" . $_POST['season_id'] . "',match_no='" . $_POST['match_no'] . "',team_1='" . $_POST['team_1'] . "',team_2='" . $_POST['team_2'] . "'";
...
$result = mysqli_query($con, "SELECT * FROM tbl_schedule WHERE id='" . $_GET['id'] . "'");
